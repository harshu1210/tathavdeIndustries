...
@Component({
  selector: 'app-triple-sliding-window',
  templateUrl: './triple-sliding-window.component.html',
  styleUrls: ['./triple-sliding-window.component.css']
})
export class TripleSlidingWindowComponent implements OnInit {
