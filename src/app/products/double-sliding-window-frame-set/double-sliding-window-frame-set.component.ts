...
@Component({
  selector: 'app-double-sliding-window-frame-set',
  templateUrl: './double-sliding-window-frame-set.component.html',
  styleUrls: ['./double-sliding-window-frame-set.component.css']
})
export class DoubleSlidingWindowFrameSetComponent implements OnInit {
  ...
  doubleSlidingWindow() {
    ...
    this.mainFrameWidth=this.width*2+this.frameThickness*2;
    ...
    mainLeftFrame.position.set(-(this.mainFrameWidth/2), 0, -this.frameThickness / 2);
    mainRightFrame.position.set(this.mainFrameWidth/2, 0, -this.frameThickness / 2);
